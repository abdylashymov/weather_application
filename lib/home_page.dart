...
import 'package:weather_application/components/custom_drawer_button.dart';
import 'package:weather_application/components/degree_widget.dart';
import 'package:weather_application/components/place_and_date_widget.dart';
import 'package:weather_application/components/scaffold_gradient.dart';
import 'package:weather_application/components/search_icon_button.dart';
import 'package:weather_application/components/weather_info.dart';
import 'package:weather_application/components/weather_tab.dart';
import 'package:weather_application/models/weather_data.dart';
import 'package:weather_application/theme/app_text_styles.dart';

const apiKey = '60c88415b15e49f6bf145531241707';
      ...
      body: isLoading
          ...
          : ListView(
              children: [
                ...
                DegreeWidget(
                  iconPath:
                      'assets/icons/${_getIconName(data?.current.condition.code ?? 1000)}.svg',
